...
export interface BrowserContextFactory {
  ...
  createContext(clientInfo: ClientInfo, abortSignal: AbortSignal, params: any): Promise<{ browserContext: playwright.BrowserContext, close: (dispose: boolean) => Promise<void> }>;
}
