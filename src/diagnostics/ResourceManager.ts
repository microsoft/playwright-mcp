...
export class ResourceManager implements SmartTracker {
  private readonly resources = new Map<string, { resource: any; disposeMethod: string; timestamp: number }>();
  private disposeTimeout = 30000; // 30 seconds default
  private nextId = 1;
  ...
  createSmartHandle<T>(resource: T, disposeMethod: keyof T): { handle: T; id: string } {
