...
program
    ...
    .option('--action-timeout <ms>', 'default timeout for actions in milliseconds (default: 5000)', parseInt)
    .option('--navigation-timeout <ms>', 'default timeout for navigation in milliseconds (default: 60000)', parseInt)
    .option('--load-timeout <ms>', 'default timeout for load state in milliseconds (default: 5000)', parseInt)
