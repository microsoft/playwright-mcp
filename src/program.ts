...
program
    ...
    .option('--request-pattern-blocklist <patterns>', 'Comma-separated list of Playwright Glob URL patterns to block the browser from requesting. Blocklist is evaluated before allowlist.', commaSeparatedList)
